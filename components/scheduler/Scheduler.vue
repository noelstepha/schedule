  ...
  data() {
      return {
          scheduleOptions: <ScheduleModel>{
            ...
            eventSettings: {
              dataSource:  <Object[]>extend([], (dataSource as any).resourceData.concat((dataSource as any).timelineResourceData), undefined, true)
            }
          }
      }
  },
    ...
    mounted (): void {
      ...
      let scheduleObj: Schedule = new Schedule(this.scheduleOptions, '#Schedule');
    }
})
</script>
